...
Route::middleware(['auth', 'role:mahasiswa'])->prefix('mahasiswa')->group(function () {
    ...
    Route::get('/master-poin/peran/{jenis_kegiatan_id}',
        [BuktiController::class, 'getPeran']);

    Route::get('/master-poin/tingkat/{jenis_kegiatan_id}/{peran}',
        [BuktiController::class, 'getTingkat']);
    Route::get('/bukti/transkrip/pdf', 
...
Route::middleware(['auth','role:dosen_wali'])->prefix('dosen')->group(function () 
{
        ...
        Route::post('/bukti/{id}/approve', [DosenBuktiController::class, 'approve']);
        Route::post('/bukti/{id}/reject', [DosenBuktiController::class, 'reject']);
        Route::get('/catatan', [DosenBuktiController::class, 'catatanKaprodi']
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/users/{user}/assign-dosen-wali',
        [DosenWaliController::class, 'assignSingle'])
        ->name('users.assign-dosen');
    //cetak laporan 
